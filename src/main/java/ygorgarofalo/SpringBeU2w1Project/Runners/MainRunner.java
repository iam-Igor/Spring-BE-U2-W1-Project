...
public class MainRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
       ...
       /*  edificioService.saveEdificio(e1);
        ...
        Postazione pos1FromDb = postazioneService.findByUUID("0e541094-27cc-48e9-9c33-154ca85e9c32");
        Postazione pos2FromDb = postazioneService.findByUUID("935da514-0bd1-4d5c-9e80-fad760ddc6d4");
        ...
        //Salvo la prenotazione con il suo metodo save che ha gia integrato i controlli su utente, postazione e data
        ...
        //RICERCA EDIFICI PER CITTA'
        edificioService.findByCityName("Barone a mare");


        //RICERCA EDIFICIO PER NOME EDIFICIO
        edificioService.findByNomeEdificio("Santoro-Villa SPA");

        //RICERCA POSTAZIONI CON UN NUMERO MINIMO E MASSIMO DI PARTECIPANTI
        postazioneService.findByNumOccupantiTraMinMax(4, 14);


        //RICERCA UTENTI TRAMITE USERNAME
        userService.findByUsername("laura.parisi");


        //RICERCA PRENOTAZIONI PER UN UTENTE SPECIFICO
